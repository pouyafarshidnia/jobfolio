...
const flashMessage = computed(() => {
    const toast = page.flash.toast as Record<string, string> | undefined;
...
<template>
    ...
    <div class="p-5">
        ...
        >
            <template #default>
                <Form
                    v-bind="CountriesController.store.form()"
                    method="post"
                    reset-on-success
        ...
        <!-- List -->
        <div
            class="mt-10 grid grid-cols-3 gap-4 md:grid-cols-5 lg:grid-cols-10"
        >
